...
Append [copilot-review-instructions.md](./assets/copilot-review-instructions.md) to `.github/copilot-instructions.md` when enabling Copilot review:

```bash
cat go/golang-continuous-integration/assets/copilot-review-instructions.md >> .github/copilot-instructions.md
```
