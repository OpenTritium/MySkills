...
## Optional: Testify Mocks

Create interfaces for your dependencies, then mock them. The following pattern is for projects that already use `stretchr/testify`; a hand-written fake is the default for new tests.

Keep the dependency's official documentation nearby for the full `mock` API (argument matchers, call modifiers, and verification).
