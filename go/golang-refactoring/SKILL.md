...
- **Simple-sweep mode** — a single mechanical, behavior-preserving transform applied tree-wide; keep it isolated and fully verified before merging.
...
- [workflow.md](references/workflow.md) covers the full choreography — read it before planning any multi-step refactor:
  ...
  - why unattended orchestration is the wrong tool for this
