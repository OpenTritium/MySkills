...
Use the project's approved dependency-graph viewer only when the text output from `go mod graph` is insufficient. Treat generated graph files as review artifacts and do not add a visualization dependency to production code.
