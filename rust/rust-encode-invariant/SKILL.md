...
Use `rust-ecosystem` for dependency, feature, and build portability questions; use `rust-zero-alloc` for measured hot-path allocation optimization. This skill decides whether a type-level invariant or immutability guarantee justifies its representation and integration cost.
