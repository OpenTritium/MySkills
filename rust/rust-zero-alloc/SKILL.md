---
name: rust-zero-alloc
description: 'Review avoidable heap allocation in Rust hot paths: owned parameters, temporary strings, repeated collection, missing capacity, buffer reuse, SmallVec/ArrayVec, Cow, boxing, and slice-versus-Vec signatures. Keywords: rust-zero-alloc, allocation, heap, stack, iterator, pre-allocate, capacity, format!, collect, SmallVec, ArrayVec, Cow, buffer reuse, 零分配, 内存优化'
---
